...
/**
 * Simulates a game containing a main player of type {@link Hand} and 3 hidden
 * dummy players.
 */
public class Game {
    private Hand player;
     ...
     * 
     * @param firstToStart Takes an integer argument of the interval [0, 3] of
     *                     natural numbers
     *                     to simulate which player starts first, with 3 being the
     *                     main player
     *                     and 0 being the next going counterclockwise. If the
     *                     argument is
     *                     outside of the interval an
     *                     {@link IllegalArgumentException} will be
     *                     thrown.
     */
    public Game(int firstToStart) {
        ...
        for (int type = 0; type < 10; type++) {
            ...
            if (type < 3) {
                ...
                // Case for Winds (North, South, East and West) and Dragons (Red, Green and
                // White)
            } else {
                // Generate 4 copies of given tile
        ...
        // Generate a random hand simulating the main player (other players are
        // currently ignored)
     ...
     * Returns false once there are
     * no tiles left to draw. Otherwise simulates dummy players drawing and
     * discarding a tile until the
     * main player draws a tile again, then returns true.
     * 
     * @param tile The index of the to-be-discarded tile. Must be a positive integer
     *             smaller than the hand size or 0.
     * @return True if the discard was successful and it's the main player's turn
     *         again. False if at some players
     *         turn (be it main player or dummy) before being able to draw, there
     *         are no more tiles left to draw.
     * @throws IndexOutOfBoundsException If discard is negative or greater than the
     *                                   main players hand size.
     */
    ...
    /**
     * Prints the discards of all players in the console with the first discard pile
     * belonging to the main player and then going around counterclockwise.
     */
